...
export default function CommandPalette({
  ...
  const commands: Command[] = [
    ...
    { id: "edit", label: "Switch to Edit Mode", shortcut: "⌃⇧E", action: () => onSetViewMode("edit") },
    ...(availableModes.includes("preview") ? [{ id: "preview", label: "Switch to Preview Mode", shortcut: "⌃⇧E", action: () => onSetViewMode("preview") }] : []),
    ...(availableModes.includes("split") ? [{ id: "split", label: "Switch to Split View", shortcut: "⌃⇧E", action: () => onSetViewMode("split") }] : []),
